...
Rookery OS is built upon the foundation of the **Linux From Scratch** project, which provides comprehensive instructions for building a Linux system from source code.

### What We Use

This project utilizes the **computer instructions and build commands** from [Linux From Scratch 12.4 (systemd)](https://www.linuxfromscratch.org/lfs/view/12.4/), which are licensed under the **MIT License** as stated in the LFS book.
...
Rookery OS does **not** copy or redistribute the **narrative text, explanations, or editorial content** of the LFS book, which is licensed under Creative Commons Attribution-NonCommercial-ShareAlike 2.0.
...
Rookery OS aims to make this educational experience more accessible through automation, while preserving the learning value.

---

## Rookery OS Original Contributions

The following are **original contributions** of the Rookery OS project:
...
### Grsecurity
- **Purpose**: Linux kernel security patches
- **Website**: https://grsecurity.net/
- **License**: GPL v2
- **Usage**: Kernel hardening for security
...
Rookery OS is designed as an **educational tool** to complement the LFS book, not replace it. We recommend:

1. **Start with LFS Book**: Read [LFS 12.4](https://www.linuxfromscratch.org/lfs/view/12.4/) to understand concepts
2. **Use Rookery OS for Practice**: Automate the build to focus on understanding rather than manual execution
...
Each approach has different goals and trade-offs. Rookery OS focuses on:
- Docker-native architecture
- Educational transparency (readable scripts)
- Modern DevOps practices
- Security hardening (grsecurity kernel)
...
Any narrative text from the LFS book (if quoted) would be under Creative Commons Attribution-NonCommercial-ShareAlike 2.0. However, Rookery OS intentionally avoids copying such content—instead referring users to the original book.
