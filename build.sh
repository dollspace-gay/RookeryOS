...
echo "     docker run --rm -v easylfs_lfs-dist:/dist -v \$(pwd):/output alpine cp /dist/${IMAGE_NAME}.img /output/"
...
echo "     docker run --rm -v easylfs_lfs-dist:/dist -v \$(pwd):/output alpine cp /dist/${IMAGE_NAME}.iso /output/"
